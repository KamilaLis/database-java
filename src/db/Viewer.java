...
public class Viewer implements WindowListener{
	...
	public void createAndShowGUI() {
		...
		tp.add("zapytania",new GUIQueryPanel(width/2, height/2));  
		tp.add("dodawanie",new GUIAddPanel(width/2, height/2));  
		tp.add("usuwanie",new GUIRemovePanel(width/2, height/2));  
		tp.add("wypisywanie",new GUITablePanel(width/2, height/2));  
